...
func (t Duplex) Register(name string) language.Type {
	var result = t
	result.Expression = language.Statement(name)
	return result
}
...
func (t Real) Register(name string) language.Type {
	var result = t
	result.Expression = language.Statement(name)
	return result
}
...
func (t Sound) Register(name string) language.Type {
	var result = t
	result.Expression = language.Statement(name)
	return result
}
...
func (t Bit) Register(name string) language.Type {
	var result = t
	result.Expression = language.Statement(name)
	return result
}
...
func (t Byte) Register(name string) language.Type {
	var result = t
	result.Expression = language.Statement(name)
	return result
}
...
func (t Color) Register(name string) language.Type {
	var result = t
	result.Expression = language.Statement(name)
	return result
}
...
func (t Image) Register(name string) language.Type {
	var result = t
	result.Expression = language.Statement(name)
	return result
}
...
func (t Video) Register(name string) language.Type {
	var result = t
	result.Expression = language.Statement(name)
	return result
}
...
func (t Time) Register(name string) language.Type {
	var result = t
	result.Expression = language.Statement(name)
	return result
}
...
func (t Ring) Register(name string) language.Type {
	var result = t
	result.Expression = language.Statement(name)
	return result
}
...
func (t Tree) Register(name string) language.Type {
	var result = t
	result.Expression = language.Statement(name)
	return result
}
...
func (t Graph) Register(name string) language.Type {
	var result = t
	result.Expression = language.Statement(name)
	return result
}
...
func (t Error) Register(name string) language.Type {
	var result = t
	result.Expression = language.Statement(name)
	return result
}
...
func (t Queue) Register(name string) language.Type {
	var result = t
	result.Expression = language.Statement(name)
	return result
}
...
func (t Table) Register(name string) language.Type {
	var result = t
	result.Expression = language.Statement(name)
	return result
}
...
func (t Array) Register(name string) language.Type {
	var result = t
	result.Expression = language.Statement(name)
	return result
}
...
func (t List) Register(name string) language.Type {
	var result = t
	result.Expression = language.Statement(name)
	return result
}
...
func (t Set) Register(name string) language.Type {
	var result = t
	result.Expression = language.Statement(name)
	return result
}
